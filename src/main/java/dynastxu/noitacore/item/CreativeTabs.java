...
public final class CreativeTabs {
    ...
    public static final Supplier<CreativeModeTab> NOITA_SPELL_TAB =
            CREATIVE_MODE_TABS.register("noita_spell_tab", () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.noitacore.noita_spells"))
                    .icon(() -> new ItemStack(Items.SPELL_MANA_REDUCE.get()))
                    .displayItems((_, output) -> {
                        ...
                        output.accept(Items.SPELL_DISC_BULLET_BIG.get());
                        // Modifier
    ...
    public static final Supplier<CreativeModeTab> NOITA_BLOCK_TAB =
            CREATIVE_MODE_TABS.register("noita_block_tab", () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.noitacore.noita_blocks"))
