...
public final class ClientSetup {
    ...
    public static void registerRenderers(EntityRenderersEvent.@NonNull RegisterRenderers event) {
        ...
        event.registerEntityRenderer(EntityTypes.DISC_BULLET_CORPSE.get(), context -> new DiscBulletRenderer(context, true));
        event.registerEntityRenderer(EntityTypes.DISC_BULLET_BIG.get(), DiscBulletBigRenderer::new);
        event.registerEntityRenderer(EntityTypes.DISC_BULLET_BIG_CORPSE.get(), context -> new DiscBulletBigRenderer(context, true));
    }
    ...
    public static void registerLayerDefinitions(EntityRenderersEvent.@NonNull RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(DiscBulletBigModel.LAYER_LOCATION, DiscBulletBigModel::createBodyLayer);
    }
